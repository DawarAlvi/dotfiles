...
function _M.get()
    local globalkeys = gears.table.join (
        ...
        -- Launch programs
        awful.key({modkey}, "a", function() awful.spawn.with_shell(rofi_command) end, { description = "open rofi program launcher", group = "launcher" }), 
        awful.key({modkey}, "e", function() awful.spawn(file_manager) end, { description = "open file manager", group = "launcher" }), 
        awful.key({modkey}, "w", function() awful.spawn(browser) end, { description = "open web browser", group = "launcher" }), 
        ...
        awful.key({modkey}, "q", function() RC.mainmenu:show() end, { description = "show main menu", group = "awesome" }),
    ...
    awful.key({modkey, "Control"}, "Right", function() awful.client.moveresize(0, 0, 20, 0) end), -- Move
